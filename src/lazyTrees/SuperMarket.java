...
public class SuperMarket
{
     ...
     */
    //UPDATE: Currently the way Item class constructor instantiates a new object and when the call to insert() occurs.
    //The result is the an item will not be re-inserted with the correct count of 1 if had been previously lazily deleted.
    // To correct this behavior, in your SuperMarket class replace the method addToInventory() with the following:
